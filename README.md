...
$ git clone https://YOUR USERNAME@bitbucket.org/fv-team/foundation-wp-theme.git
$ npm install
```
...
## Local Development
I recommend using one of the following setups for local WordPress development:
